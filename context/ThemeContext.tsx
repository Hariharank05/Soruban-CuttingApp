...
const DARK_COLORS: ThemeColors = {
  ...
  green: '#66BB6A',
  greenLight: '#1B3A1D',
  text: { primary: '#E0E0E0', secondary: '#A0A0A0', muted: '#6B6B6B', white: '#FFFFFF', accent: '#66BB6A' },
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = useMemo(() => ({ themeMode, isDark, colors, setThemeMode }), [themeMode, isDark, colors, setThemeMode]);
