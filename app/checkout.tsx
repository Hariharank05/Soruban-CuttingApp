...
const styles = StyleSheet.create({
  ...
  slotRowActive: { backgroundColor: '#FFF3E0' },
  ...
  dateChipActive: { borderColor: COLORS.primary, backgroundColor: '#FFF3E0' },
  ...
  timeChipActive: { borderColor: COLORS.primary, backgroundColor: '#FFF3E0' },
  ...
  paymentRowActive: { backgroundColor: '#FFF3E0' },
