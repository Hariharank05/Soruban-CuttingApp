...
const styles = StyleSheet.create({
  ...
  variantCardActive: { borderColor: COLORS.primary, backgroundColor: '#FFF3E0' },
  ...
  sizeChipActive: { borderColor: COLORS.primary, backgroundColor: '#FFF3E0' },
  ...
  miniChipActive: { borderColor: COLORS.primary, backgroundColor: '#FFF3E0' },
  ...
  cutChipActive: { borderColor: COLORS.primary, backgroundColor: '#FFF3E0' },
